  ...
  function handleClick(){
    ...
    return(
      ...
      <div className="w-screen h-14 sticky top-0 flex flex-row items-center justify-between z-10">
        ...
        <Image className={`w-8 z-10 mx-4 cursor-pointer hover:scale-125`} onClick={handleClick} src={hamburger}></Image>
        <h1 className="text-2xl text-slate-50">▶️NewTube</h1>
        </div>
        <div className="flex flex-row">
        <input className="px-3 py-1 w-24 focus:outline-none xl:w-[] lg:w-96 md:w-64 sm:40 placeholder-gray-500 font-semibold rounded-l-2xl" placeholder="Search" autocomplete="off" type="text"></input>
